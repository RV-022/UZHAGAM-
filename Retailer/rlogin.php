...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			//read from database
			$query = "select * from retailerlogindb where user_name = '$user_name' limit 1";
...
<body>
	...
	<div id="box">
		...
		<form method="post">
			...
			<center><input id="button" type="submit" value="Login"></center><br>

			<center><a href="rsignup.php">Click to Signup</a></center><br><br>
		</form>
	</div>
